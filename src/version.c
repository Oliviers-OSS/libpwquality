...
MODULE_DESCRIPTION(Password Quality Extended Library: Users profiles management and additionals password quality checks);
MODULE_COMMENT(First version);
...
void displayVersionInfo(void)
{
    ...
    printf("ABI Level: 1.0.2 (tested against libpwquality v1.3.0 up to v1.4.2)\n");
